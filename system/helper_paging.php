...
class pagingGallery{
	...
	function navHalaman($halaman_aktif, $jmlhalaman){
		...
		if($halaman_aktif < $jmlhalaman){
			$next = $halaman_aktif+1;
			$link_halaman .= " <a href='galeri-page-$next' title='Next'><i class='icofont-bubble-right' aria-hidden='true'></i></i></a>
							 <a href='galeri-page-$jmlhalaman'>Last <i class='icofont-bubble-right' aria-hidden='true'></i></a>
							 ";
		}else{
			$link_halaman .= "";
		}
