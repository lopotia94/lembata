                                        ...
                                        <div class="col-md-10">
                                            <select class="select2 m-b-10 select2-multiple " multiple="multiple"
                                                ...
                                                <?php foreach ($tags as $row): ?>
                                                    <option value="<?php echo $row['id_tags'] ?>">
                                                    <?php echo $row['judul'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                        <div class="col-md-2">
                                            <a class="btn btn-info" href="tag"><i class="fa fa-plus"></i> Tag
                                            </a>
                                        </div>
                                    </div>
                                    <input type="hidden" name="id_tags" id="id_tag" class="myTag">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i
                                                class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                                                <input name="tgl" class="date_time form-control" type="text" id="result"
                                            value="<?=$data['tgl']?>" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <select style="width:100%" name="tagNyan"
                                                ...
                                                <option value="<?php echo $row['id_tags'] ?>"><?php echo $row['judul'] ?>
                                                </option>
                                                <?php endforeach ?>
                                                <?php }else{ ?>
                                                <?php foreach ($tag->fetchAll() as $row): ?>

                                                <option value="<?php echo $row['id_tags'] ?>" <?php 
                                                    foreach($tags as $tag){
                                                        if($tag['id_tags'] == $row['id_tags'])
                                                        {
                                                            echo "selected";
                                                        }else{
                                                            echo "";
                                    ...
                                    <input type="hidden" name="id_tags" id="id_tag" class="myTag" value="0">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
