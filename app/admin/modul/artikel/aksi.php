            ...
            if ( ( $ukuran == 0 ) OR ( $ukuran == 02 ) OR ( $ukuran>9060817 ) ) {
                ...
                if ( $res == true ) {
                    try {
                        ...
                        lopoCompress( 'artikel', $pathToImage, $tipe_file2, 2 );
                        ...
                        $image2->resizeToWidth(800);
                        $image2->save($pathToImage);
                        $msg->info("$hal Berhasil diedit");
                        echo "<script> window.location = '$hal-edit-$_POST[id_artikel]'</script>";
