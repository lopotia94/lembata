<?php $this->layout('template', ['hal'=>'SK Jalan Kabupaten']) ?>
<?php
	$module = "sizechart";
    ...
    <table id="my_table" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><label for="" class="label label-info" style="font-size: 14px;"><?= getSize('images/sizechart/'.$row['gambar']) ?> MB</label></td>
                <td style="width:12%" ><a href="../images/sizechart/<?php echo $row['gambar'] ?>" class="btn btn-info" download>
                        <i class="fas fa-download"></i> </a>
                    <a  target="_blank" href="../images/sizechart/<?php echo $row['gambar'] ?>" class="btn btn-secondary "
