                                            ...
                                            <div class="col-md-2 col-xs-12"
                                                ...
                                                <div class="d-flex justify-content-center w-100">
                                                    ...
                                                    <a style="margin-top:10px" class="btn btn-danger"
                                                        ...
                                                        href='referensi-gallery-delete-<?php echo $tsubpro['id_gallery']; ?>-<?php echo $data['id_produk']; ?>'>Hapus</a>
                                                </div>
                                            </div>
                                            <?php
                                                endforeach;
...
<?php
	...
	case "addgallery":
?>
<form action="referensi-gallery" method="POST" enctype="multipart/form-data">
    <div class="row">
