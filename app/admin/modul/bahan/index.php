<?php $this->layout('template', ['hal'=>'Jenis Bahan']) ?>
<?php
	$module = "bahan";
	switch($act){
        case "list":
...
<a href="bahan-add" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data</a>
    ...
    <table id="my_table" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="../images/bahan/small/<?php echo $row['gambar']; ?>"
                        style="width:100px;margin:0 auto;display:block">
                </td>
                <td style="width:19%"><a href="bahan-edit-<?php echo $row['id_bahan'] ?>" class="btn btn-warning "> <i
                            class="fas fa-pencil-alt"></i> Edit</a>
                    <a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');"
                        href="<?php echo $module; ?>-delete-<?php echo $row['id_bahan']; ?>" class="btn btn-danger "
    ...
    <div class="card-body">
        <form action="bahan" method="POST" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-12">
                    <button type="submit" id="btn-bahan" class="btn btn-primary"><i class="fa fa-paper-plane"></i>
                        Simpan</button>
                </div>
            </div>
        </form>
...
<div class="card">
    <div class="card-body">
        <form action="bahan" id="form-bahan" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="" id="img-lopo">
                            <img style="height:200px" src="../images/bahan/<?php echo $data['gambar'] ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <input type="submit" id="btn-bahan" class="btn btn-primary" value="Simpan Data">
            </div>
        </form>
    </div>
</div>
<?php
	...
	case "addgallery":
?>
<form action="modul/bahan/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
...
<?php
    break;
	case "editgallery":
	$gam =  $db->connection("SELECT * FROM gallery_bahan WHERE id_gallery = '$_GET[id]'  ")->fetch();
?>
        ...
        <div class="col-md-12 card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="nyanpload" class="form-control">
                    <br><br>
                    <img style="height:300px" src="../images/gallery_bahan/<?php echo $imgname2."-".$gam['gambar']?>">
                </div>
            </div>
        </div>
        <input type="submit" class="btn btn-info" value="Simpan Data">
