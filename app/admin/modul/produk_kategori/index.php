...
<?php
	$module = 'produk-kategori';
	switch($act){
		case "list":
	?>
<a href="produk" class="btn btn-secondary"> <i class="sl-icon-present"></i> Produk</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="produk-kategori" method="POST"
                                                ...
                                                <input type="hidden" name="id_produk_kategori"
                                                    value="<?php echo $r['id_produk_kategori']; ?>">
...
<div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="produk-kategori" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/produk_kategori/aksi.php?module=<?php echo $module; ?>&act=add"
                    method="POST" enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul produk_kategori <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="produk_kategori" type="hidden" class="form-control"
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/produk_kategori/aksi.php?module=<?php echo $module; ?>&act=update"
                    method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_produk_kategori"
                        value="<?php echo $tedit['id_produk_kategori']; ?>">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/produk_kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery"
            method="POST" enctype="multipart/form-data">
