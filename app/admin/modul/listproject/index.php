                                            ...
                                            <form action="listproject" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="kategori" class="form-control" id="">
                                                        <option value="INDONESIAN HOTEL PROJECT"
                                                            <?=($r['kategori'] != 'HOTEL PROJECT ABROAD') ? 'selected' : '' ?>>
                                                            INDONESIAN HOTEL PROJECT</option>
                                                        <option value="HOTEL PROJECT ABROAD"
                                                            <?=($r['kategori'] == 'HOTEL PROJECT ABROAD') ? 'selected' : '' ?>>
                                                            HOTEL PROJECT ABROAD</option>
                                                    </select>
                                                </div>
                                        </div>
            ...
            <div class="modal-body">
                <form action="listproject" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">Kategori</label>
                        <select name="kategori" class="form-control" id="">
                            <option value="INDONESIAN HOTEL PROJECT">INDONESIAN HOTEL
                                PROJECT</option>
                            <option value="HOTEL PROJECT ABROAD">HOTEL PROJECT ABROAD
                            </option>
                        </select>
                    </div>
            </div>
