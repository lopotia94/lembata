            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <nav class="breadcrumb">
                        ...
                        <span>Kegiatan yang Dilaksanakan Tahun Berjalan</span>
                    </nav>
                </div>
                ...
                <div id="primary" class="content-area blog-classic col-md-12 col-sm-12 col-xs-12">
                    ...
                    <main id="main" class="site-main ">
                        ...
                        <div class="fh-section-title clearfix  text-left style-1 mb-15">
                            <h2>Kegiatan yang Dilaksanakan Tahun Berjalan</h2>
                        </div>
                        ...
                        <table id="table-download" class="table table-bordered">
                            ...
                            <tbody>
                                <?php $no=1;foreach($kegiatan as $r) : ?>
                                <tr>
                                    <td width="10%" style="text-align:center;"><?=$no?></td>
                                    <td width="45%" align="left"><?=$r['nama']?></td>
                                    <td width="10%"><label for="" class="label label-warning" style="font-size: 14px;"><?= getSize('images/kegiatan/'.$r['gambar']) ?> MB</label></td>
                                    <td width="10%"><?=tgl2($r['tgl'])?></td>
                                    <td width="25%">
                                        <a class="btn btn-primary" href="images/kegiatan/<?=$r['gambar']?>" download> <i class="fa fa-download"></i> Download</a>
                                        <a target="_blank" class="btn btn-warning" href="kegiatan-<?=$r['slug']."-".$r['id_kegiatan']?>"><i class="fa fa-eye"></i> Tampilkan</a>
                                    </td>
