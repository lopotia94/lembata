    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mb-4">
                <?php if(!empty($multi)) : ?>
                <ul class="pgwSlider">
                    <li><img src="images/referensi/<?php echo $data['gambar'] ?>"></li>
                    <?php foreach($multi as $r) : ?>
                    <li><img src="images/gallery_referensi/<?php echo $imgname1."-".$r['gambar'] ?>"></li>
                    <?php endforeach ?>
                </ul>
                <?php else : ?>
                <img src="images/referensi/<?php echo $data['gambar'] ?>" class="w-100">
                <?php endif; ?>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="col-md-3 col-6  mb-4">
                        <div class="service-widget border bg-white">
                            <div class="post-media wow fadeIn ww">
                                <a href="detail-<?=$r['judul_seo']."-".$r['id_produk']?>">
                                    <picture>
                                        <!--mobile-->
                                        <source media="(max-width: 600px)" srcset="images/referensi/<?=$r['gambar']?>">
                                        <!--dektop-->
                                        <source media="(min-width: 768px)"
                                            srcset="images/referensi/small/<?=$r['gambar']?>">
                                        <img src="images/referensi/<?=$r['gambar']?>" alt="<?=$r['judul']?>"
